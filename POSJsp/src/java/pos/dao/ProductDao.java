...
public class ProductDao implements DaoService<Product> {
    ...
    public void save(Product e) {
        ...
        try {
            ...
            Logger.getLogger(ProductDao.class.getName()).log(Level.SEVERE, "Error saving product", ex);
        }
    }
    ...
    public List<Product> findAll() {
        ...
        try {
            ...
            Logger.getLogger(ProductDao.class.getName()).log(Level.SEVERE, "Error finding all products", ex);
        }
        return list;
    }
    ...
    public Product findById(int id) {
        ...
        try {
            ...
            Logger.getLogger(ProductDao.class.getName()).log(Level.SEVERE, "Error finding product by id", ex);
        }
        return p;
    }
    ...
    public List<String> getAllProductName() {
        ...
        try {
            ...
            Logger.getLogger(ProductDao.class.getName()).log(Level.SEVERE, "Error getting all product names", ex);
        }
        return productNames;
    }
    ...
    public int findIdByName(String name) {
        ...
        try {
            ...
            Logger.getLogger(ProductDao.class.getName()).log(Level.SEVERE, "Error finding product id by name", ex);
        }
        return id;
    }
    ...
    public int count() {
        ...
        try {
            ...
            Logger.getLogger(ProductDao.class.getName()).log(Level.SEVERE, "Error counting products", ex);
        }
        return count;
    }
}
